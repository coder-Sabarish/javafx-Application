...
public class react{
    ...
    public static void re()
    {
        ...
        Label l=new Label("\t\t\t\t");
        Label cn=new Label("Course Name - REACT");
        Label cp=new Label("Course Prize - 55$");
        ...
        Image i=new Image("D:\\Documents\\java_programs\\Javafx\\course_purchase\\src\\main\\java\\com\\example\\course_purchase\\react.jpg");
