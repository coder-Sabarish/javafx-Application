...
public class html{
    ...
    public static void ht()
    {
        ...
        Label l=new Label("\t\t\t\t\t\t");
        Label cn=new Label("Course Name - HTML");
        Label cp=new Label("Course Prize - 50$");
        ...
        Image i=new Image("D:\\Documents\\java_programs\\Javafx\\course_purchase\\src\\main\\java\\com\\example\\course_purchase\\html.jpg");
