...
public class js{
    ...
    public static void j()
    {
        ...
        Label l=new Label("\t\t\t\t");
        Label cn=new Label("Course Name - Java Script");
        Label cp=new Label("Course Prize - 100$");
        ...
        Image i=new Image("D:\\Documents\\java_programs\\Javafx\\course_purchase\\src\\main\\java\\com\\example\\course_purchase\\js.png");
